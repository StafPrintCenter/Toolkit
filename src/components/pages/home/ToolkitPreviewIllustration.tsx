        ...
        <div className="p-4 space-y-3 bg-background/50">
          ...
          <div className="rounded-xl border border-border bg-card p-3 shadow-sm">
            ...
            <div className="grid grid-cols-4 gap-1.5 pt-1">
              ...
              <div className="rounded bg-slate-900/15 border border-slate-900/30 dark:bg-slate-900/60 dark:border-slate-700 p-1.5 text-center">
                <span className="block font-mono text-[9px] text-foreground dark:text-slate-200">N: 10%</span>
              </div>
            </div>
          </div>
