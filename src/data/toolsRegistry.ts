...
export const TOOLS: ToolItem[] = [
  {
    ...
    shortDescription:
      "Convertissez vos couleurs écran en encres CMJN et simulez le rendu papier mat ou brillant.",
  ...
  },
  {
    ...
    shortDescription:
      "Vérifiez si votre image tient la route à la taille d'impression voulue, du flyer au roll-up.",
    category: "prepression",
    icon: "ScanEye",
  ...
  },
  {
    ...
    shortDescription:
      "Générez un gabarit avec coupe, fond perdu 3 mm et marge de sécurité. Export PNG / PDF.",
    category: "prepression",
    icon: "Crop",
    badge: "Export PDF",
  ...
  },
  {
    ...
    shortDescription:
      "Contrôlez la somme C+M+J+N de vos aplats pour éviter maculage et surcharge d'encre.",
    category: "prepression",
    icon: "Droplets",
  ...
  },
  {
    ...
    shortDescription:
      "Calculez le dos d'un livre ou catalogue selon le grammage, les pages et le type de reliure.",
    category: "print",
    icon: "BookOpen",
  ...
  },
  {
    ...
    shortDescription:
      "Visualisez dépliants 2 volets, accordéon ou roulé, avec la largeur exacte de chaque volet.",
    category: "print",
    icon: "Layers",
    badge: "Interactif",
  ...
  },
  {
    ...
    shortDescription:
      "Créez des QR codes et codes-barres EAN-13 / Code 128 vectoriels, prêts pour l'impression.",
    category: "print",
    icon: "QrCode",
    badge: "SVG / PDF",
  ...
  },
  {
    ...
    shortDescription:
      "Optimisez la pose de vos visuels sur laize 1,60 m ou 3,20 m et réduisez le gâchis matière.",
    category: "format",
    icon: "Grid2x2",
  ...
  },
  {
    ...
    shortDescription:
      "Tailles S à XXL et zones d'impression : cœur, A4 poitrine, A3 dos, manche.",
    category: "format",
    icon: "Shirt",
  ...
  },
  {
    ...
    shortDescription:
      "Fusionnez, extrayez des pages et passez en niveaux de gris, 100 % dans votre navigateur.",
    category: "pdf",
    icon: "FileText",
    badge: "Zero-Server",
